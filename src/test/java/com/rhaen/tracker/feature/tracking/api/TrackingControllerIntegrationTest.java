...
class TrackingControllerIntegrationTest extends BaseIntegrationTest {
        @Autowired
        ...
        void start_ingest_stop_flow_success() throws Exception {
                ...
                UUID sessionId = UUID
                                .fromString(objectMapper.readTree(startBody).path("data").path("sessionId").asText());
                ...
                mockMvc.perform(post("/api/v1/tracking/sessions/" + sessionId + "/stop")
                                ...
                                .content(objectMapper.writeValueAsString(
                                                new TrackingDtos.StopSessionRequest(null, null, null))))
                                .andExpect(status().isOk());
        }
        ...
        private String registerAndLogin(String prefix) throws Exception {
                ...
                String loginBody = mockMvc.perform(post("/api/v1/auth/login")
                                ...
                                .content(objectMapper
                                                .writeValueAsString(new AuthDtos.LoginRequest(username, password))))
                                .andExpect(status().isOk())
                                .andReturn().getResponse().getContentAsString();
